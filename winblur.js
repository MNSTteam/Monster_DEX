...
(function($) {
  $(function() {
      ...
      for(var x=0; x<windowobject.length; x++) {
        ...
        $(windowobject[x]).parent(".box_window").prepend('<div class="box_title" data-clipboard-text="-" data-clipboard-action="copy">'+wintitle+'</div>');
        ...
        //$(windowobject[x]).addClass("noscroll");
        	//}
        }
      ...
      if (popwindow.length) {
        ...
        popbutton.click(function(){
            ...
            if($("#" + idwind).prop('scrollHeight')<$("#" + idwind).parent(".box_window").innerHeight()) { 
            	$("#" + idwind).addClass("noscroll");
            } else {
            	$("#" + idwind).removeClass("noscroll");
            }
